#!/usr/bin/env python3
"""TP904 high-level example using built-in connect()."""

from __future__ import annotations

import argparse

from tp90x import SearchMode, TP904, TemperatureBroadcast
...
def main() -> int:
    parser = argparse.ArgumentParser(description="TP904 high-level example")
